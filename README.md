...
- Chooses which LLM / image / animation models to use for this project. The video-metadata thumbnail preview follows the applied style template's video ratio: 9:16 for Reels and 16:9 otherwise.
