...
The project workspace has a Copy script control beside the current word count. It copies the live editor content, including unsaved edits, rather than only the last autosaved script.
