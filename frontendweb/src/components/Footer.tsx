  ...
  return (
    <footer className="border-t border-slate-200/80 bg-white/55 px-6 py-3.5 text-center text-xs text-slate-500 backdrop-blur dark:border-white/[.07] dark:bg-slate-950/50 dark:text-slate-500">
      <div className="flex flex-col md:flex-row items-center justify-between">
        <span>&copy; {new Date().getFullYear()} vgAI2. All rights reserved.</span>
        <div className="flex items-center gap-4 mt-2 md:mt-0">
          ...
          <Link href="/pricing" className="transition-colors hover:text-brand-600 dark:hover:text-brand-300">Pricing</Link>
          <Link href="/terms-and-conditions" className="transition-colors hover:text-brand-600 dark:hover:text-brand-300">Terms</Link>
          <Link href="/cancellation-refund-policy" className="transition-colors hover:text-brand-600 dark:hover:text-brand-300">Refunds</Link>
