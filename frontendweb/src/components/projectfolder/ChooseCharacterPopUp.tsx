...
export const ChooseCharacterPopUp = ({
  ...
  return (
    ...
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative w-full sm:max-w-lg lg:max-w-3xl overflow-hidden rounded-t-3xl sm:rounded-3xl bg-white dark:bg-surface shadow-2xl dark:shadow-slate-950/80 ring-1 ring-slate-200/80 dark:ring-border max-h-[90vh] flex flex-col">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {importedCharacters.map((c) => (
                  <span
                    key={c.id}
                    className="flex items-center gap-2 pl-1 pr-2 py-1 rounded-full bg-brand-50 dark:bg-brand-500/10 border border-brand-100 dark:border-brand-500/30 text-[13px] text-brand-700 dark:text-brand-300"
                  >
                    <button
                      type="button"
                    ...
                    <button
                      ...
                      className="text-brand-400 hover:text-brand-600 dark:hover:text-brand-300 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="text-brand-400 hover:text-red-600 dark:hover:text-red-400 cursor-pointer disabled:opacity-60"
                    >
